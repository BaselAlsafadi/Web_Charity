                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, itemcount) {
                                return TransAction(
                                  ...
                                  update: () {
                                    setState(() {
                                      id = allExchanges[itemcount]["id"];
                                      name.text = allExchanges[itemcount]
                                          ["beneficiary_id"];
                                      amount.text = allExchanges[itemcount]
                                              ["value"]
                                          .toString();
                                  ...
                                  name: allExchanges[itemcount]
                                      ["beneficiary_id"],
                                  amount: allExchanges[itemcount]["value"],
                                  address: "Syria - Alswaida - Alkafer",
                                  date: allExchanges[itemcount]["date"]
                                      .toString(),
                                  transactionNumber: allExchanges[itemcount]
                                      ["transactionNumber"],
                                  number: '0930253884',
                                );
                              },
